...
const modules = [
  { moduleName: 'QumlLibraryModule', packageName: '@project-sunbird/sunbird-quml-player' },
...
export function addLibraryModuleToAppModule(options: Schema): Rule {
  return async (host: Tree, context: SchematicContext) => {
    ...
    if (appModuleSource) {
      ...
      insertImportToModule(host, mainFilePath, 'QuestionCursor', '@project-sunbird/sunbird-quml-player');
