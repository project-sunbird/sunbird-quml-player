export const QumlPlayerConfig = {
    ...
    'metadata': {
        ...
        'contentData': {
            ...
            'childNodes':["do_1132131789426933761152", "do_113015077903966208165", "do_1132131789426933761152", "do_113015077903966208165","do_1132131789426933761152", "do_113015077903966208165",
            "do_1132131789426933761152", "do_113015077903966208165", "do_1132131789426933761152", "do_113015077903966208165", "do_1132131789426933761152", "do_113015077903966208165","do_1132131789426933761152", "do_113015077903966208165"],
            'collections': [
                {
    ...
    'data': {
        ...
        'children': [
            ...
            },
            {
                ...
                "templateId": "mcq-grid-split",
                "name": "untitled mcq",
                "body": "<div class='question-body'><div class='mcq-title'><p>1. What does a dummy-variable regression analysis examine (having multiple seclection)?</p><p><br data-cke-filler=\"true\"></p><figure class=\"image\"><img src=\"data:image/png;base64,\" data-mathtext=\"A%3D%5Cpi%20r%5E2\" advanced=\"false\"></figure></div><div data-choice-interaction='response1' class='mcq-vertical'></div></div>",
                "responseDeclaration": {
                    "maxScore": 3,
                    "response1": {
